...
;(function (w) {
	...
	Bnr.prototype.global = {
		...
		events: {
			boxClick: function (event) {
				...
				w.open(this._currentItem.href, "_blank", "");

				return this.global.events._boxHide.call(this, 1);
			},
			_boxHide: function (save) {
				var self = this,
				...
				setTimeout(function () {
					if(save) localStorage.setItem( self.global._LSName, +new Date() );
	...
	Bnr.prototype.__randomString = randomString;
	...
	Bnr.prototype._checkStorage = function () {
		...
		if( ((+new Date()) - ls) / 1000 >= this.global.counter._boxInterval ) {
			return true;
		}
	...
	var varName = randomString(6);

	w[varName] = Bnr;

	new w[varName]([
		{src:"http://naruto-base.su/sl_25/NW_1_ah.gif",href:"http://www.ninjaworld.ru/ao258"},
		{src:"http://naruto-base.su/sl_25/NW_2_ao.gif",href:"http://www.ninjaworld.ru/ao258"},
		{src:"http://naruto-base.su/sl_25/NW_3_aw.gif",href:"http://www.ninjaworld.ru/ao258"}
	]).init();
}(window));
